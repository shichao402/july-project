<div id="content">
<?php while ($postList->getPostsByCategory($categoryId,$num,$page)) { ?>
...
<?php } ?>
    <div id="page-nav">
            ...
            if ($page > 1) {
                ...
                echo '<a href="',ROOT,'index.php?categoryid=',$categoryId,'page=',$page-1,'">上一页</a>';
                echo '</span>';
            }
            if ($page < $totalPage) {
                echo '<span class="next">';
                echo '<a href="',ROOT,'index.php?categroyid=',$categoryId,'page=',$page+1,'">下一页</a>';
                echo '</span>';
            }
            ?>
    </div>
